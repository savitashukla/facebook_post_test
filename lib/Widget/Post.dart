      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 12.0),
              child: _PostStats(nameP:widget.username,imageP:widget.userImage,likes: widget.likes,comments: widget.comments,share: widget.shares,),
            ),
          ],
        ),
      ),
...
class _PostStats extends StatelessWidget {
  ...
  final String likes, comments, share,imageP,nameP;
          ...
          children: [
            _PostButton(
              ...
              onTap: () {
                ...
                controllerV.box.write("likeValues", controllerV.likeValues.value);
