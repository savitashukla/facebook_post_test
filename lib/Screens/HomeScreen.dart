...
import '../Widget/postListDynamic.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              ...
              Obx(
                    ()=> controllerV.   images != null
                    ? ListView.builder(
                  shrinkWrap: true,
                  physics: NeverScrollableScrollPhysics(),
                  itemCount: controllerV.   images.length,
                  itemBuilder: (context, index) {
                    final imagePath = controllerV.   images[index];
                        ...
                        child: Column(
                          children: [
                            ...
                            Padding(
                              padding: const EdgeInsets.symmetric(
                                  horizontal: 12.0),
                              child: PostStatsDaynamic(
                                nameP: "Charles",
                                imageP: imagePath,
                                likes: "${controllerV.likeValues.value}",
                                comments: "1",
                                share: "13",
                              ),
                            ),
